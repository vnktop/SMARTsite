<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PLD.aspx.cs" Inherits="Smart.WebSite.PLD" %>
...
<head>
    ...
    <title>SMART - S Prevención de Lavado de Dinero</title>
    ...
    <!-- Custom CSS -->
    <link href="Estilos/agency.css" rel="stylesheet" />
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Iniciar SMART - S - PLD</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                   ...
                   <%-- <li>
                    ...
                    <li>
                        <a class="page-scroll" href="#ruta PLD">Intranet PLD</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
    ...
    <header>
        <div class="container">
            <div class="intro-text">
                <div class="intro-lead-in">Bienvenidos a SMART - S</div>
                <div class="intro-heading">módulo PLD</div>
                <a href="#services" class="page-scroll btn btn-xl">Conozca más</a>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Les presentamos el potencial de nuestros servicios.</h3>
                </div>
            </div>
            <div class="row text-center">
                <div class="col-md-6">
                    ...
                    <h4 class="service-heading">Módulo PLD</h4>
                    <p class="text-muted">Aplicación donde nuestros clientes describen mediante archivos planos la relación que tienen con sus respectivos clientes; declaran sus movimientos, para la generación de reportes PLD. De una manera simple, clara, sencilla y sobre todo confiable</p>
                </div>
                <div class="col-md-6">
                    <span class="fa-stack fa-4x">
                        <%--<i class="fa fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <p class="text-muted">Para integrar la detección de incidencias de sus clientes, ofrecemos un servicio web, de fácil integración y consumo a su core de negocio</p>
                </div>
                <%--<div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal3" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="Images/treehouse.png" class="img-responsive" alt="" />
                    </a>
                    <div class="portfolio-caption">
                        <h4>Treehouse</h4>
                        <p class="text-muted">Website Design</p>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal4" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="Images/golden.png" class="img-responsive" alt="" />
                    </a>
                    <div class="portfolio-caption">
                        <h4>Golden</h4>
                        <p class="text-muted">Website Design</p>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal5" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="Images/escape.png" class="img-responsive" alt="" />
                    </a>
                    <div class="portfolio-caption">
                        <h4>Escape</h4>
                        <p class="text-muted">Website Design</p>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal6" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="Images/dreams.png" class="img-responsive" alt="" />
                    </a>
                    <div class="portfolio-caption">
                        <h4>Dreams</h4>
                        <p class="text-muted">Website Design</p>
   ...
   <%-- <section id="team" class="bg-light-gray">
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <span class="copyright">Copyright &copy; smart - s 2014</span>
                </div>
                <%--<div class="col-md-4">
                    <ul class="list-inline social-buttons">
                        <li><a href="#"><i class="fa fa-twitter"></i></a>
